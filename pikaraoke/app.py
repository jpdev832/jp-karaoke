...
from pikaraoke.routes.autotune import autotune_bp, autotune_ui_bp
...
app.config["API_TITLE"] = "JP Karaoke API"
...
# Auto-Tune ZMQ publisher (binds before DSP daemon connects)
from pikaraoke.lib import autotune_control as at

at.set_socketio(socketio)
at.init_zmq()
...
def main() -> None:
    ...
    app.config["SITE_NAME"] = "JP Karaoke"
